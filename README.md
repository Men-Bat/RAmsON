# Lince Balcánico (Lynx Balkan)


Existen [4 Especies de Linces](https://github.com/Men-Bat/RAmsON/blob/main/Felinos.md) en el Mundo y solo una Subespecie distinta adaptada de una de ellas, en medio de todas habitando los Balcanes sobrevive el Lynx Balkan. ([Y otras en Peligro](https://github.com/Men-Bat/RAmsON/blob/main/Felinos.md).)
...
# PROPUESTA TÉCNICA DE SUBVENCIÓN INTERNACIONAL
...
*   **Consorcio Proponente y asociaciones funcionales nativas:** MES (Macedonia del Norte), PPNEA (Albania), Finch/ERA (Kosovo), en colaboración con el Ministerio de Transición Ecológica de España (Asesor Técnico Exteriormente).

---

## 2. INNOVACIÓN TECNOLÓGICA: SATELLITE-DRONES (WARNET) & MICRO-EXPLORADORES
...
### B. Micro-Drones de Exploración.        
([Mini-Air-Fly](https://github.com/yoqer/Mini-Air-Fly) )
...
*   **Criterio Genético Estricto:** Captura controlada de un número mínimo de ejemplares silvestres (evaluados mediante tecnología WARNET) para fundar una línea genética limpia, con minimo complemento viable del flujo genético monitorizado del lince boreal, e incluso estudios genéticos del ibérico; evitando una consanguinidad extrema.
...
## 4.1.- EL CORREDOR TRANSFRONTERIZO Y LA SALIDA MARÍTIMA

La mayor amenaza del lince de los Balcanes es el aislamiento en "islas ecológicas" de alta montaña. El proyecto evalúa la viabilidad de un **corredor biológico continuo desde los picos continentales hasta la costa adriática**.
...
P.N. Mavrovo / Macedonia]
           │
           ▼
[Montes Shebenik-Jabllanicë / Albania]
           │
           ▼
[Corredor Fluvial del Río Shkumbin]
           │
           ▼
[Delta del Río Vjosa / Paisaje Protegido Vjosa-Narta]  <-- Nueva Entrada Costera
           │
           ▼
[Península de Karaburun (Vlorë) / Confluencia Marítima] <-- Salida Marítima Definitiva
...
-Opción Extendida de fauna litoral:


### 4.2.- EL CORREDOR TRANSFRONTERIZO Y LA CONFLUENCIA MARÍTIMA EN VLORË

El aislamiento genético del lince de los Balcanes se mitiga mediante un corredor biológico continuo que conecta los picos alpinos con los ecosistemas del litoral mediterráneo en el suroeste de Albania.

*   **Punto de Entrada Costera (Delta de Vjosa-Narta):** Utilizando el curso del río Vjosa (declarado el primer Parque Nacional de Río Salvaje de Europa), el lince encuentra un corredor ripario protegido que lo conduce directo a la laguna y los bosques costeros de pinos de Narta. Este entorno proporciona una densidad óptima de lagomorfos (liebres) y mamíferos pequeños en épocas de invierno severo en la alta montaña.
    
*   **La Salida Marítima y Refugio (Península de Karaburun - Vlorë):** El corredor culmina en la Península de Karaburun. Al tratarse de un área estrictamente protegida y completamente libre de carreteras o desarrollo urbano, sus formaciones montañosas costeras, densos matorrales mediterráneos y desfiladeros rocosos ofrecen un santuario idóneo de aislamiento absoluto (zona núcleo).
  
*   **Unión Genética de Poblaciones:** Este eje actúa como zona de dispersión estratégica para conectar a los ejemplares reintroducidos o nativos de los Apeninos balcánicos con el litoral, permitiendo que Karaburun funcione como el nodo final de recepción de flujos de fauna, garantizando la resiliencia climática del felino al ofrecer un gradiente altitudinal que va desde los 2.000 metros de nieve hasta el nivel del Mar Adriático y el Jónico.
...
### Justificación Geográfica del Corredor:

*   **Unión de Poblaciones:** Conectar los núcleos relictos de Macedonia del Norte (Mavrovo) con los avistamientos reportados en el norte de Albania (Mirditë) y Kosovo (Bjeshkët e Nemuna).
   
*   **Vectores de Dispersión:** Utilizar las cuencas de los ríos transfronterizos como autopistas verdes naturales para evitar infraestructuras humanas.
  
*   **El Factor Marítimo (Salida al Adriático):** La inclusión de las zonas de humedales costeros y dehesas bajas mediterráneas del litoral albanés (cerca del mar Adriático) ofrece al lince un hábitat invernal rico en aves y mamíferos pequeños, replicando las dehesas costeras que Doñana ofreció al lince ibérico en España. Este corredor marítimo estabilizará el clima de dispersión de la especie frente al cambio climático global.
...
## 5. IMPACTO SOCIOECONÓMICO Y DEFENSA DEL PROYECTO ante la UE
...
(Con solo unos 50 ejemplares de la especie exclusiva de los Balcanes, es el gran felino de esta especie en Mayor ⚡ Peligro ⚡; gracias a los programas similares con sus parientes próximos: el Lince Ibérico mediterráneo y su más grande ancestro el Lince Boreal de la montaña, en cuyo centro se situa esta especie intermedia: en hábitat, clima y tamaño, aun con las mismas posibilidades de repoblación y de supervivencia que sus parientes Europeos.)
